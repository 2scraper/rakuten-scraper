#!/usr/bin/env python3
"""rakuten-scraper — 2captcha Scraper API edition (fourth engine)
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Rakuten Ichiba scraper — 2captcha Scraper API edition (no "
    ...
    p.add_argument("--url", default=None,
                   help="A Rakuten Ichiba listing URL — a keyword search "
    ...
    p.add_argument("--out", default="rakuten_products_scraperapi", help="Output file prefix")
